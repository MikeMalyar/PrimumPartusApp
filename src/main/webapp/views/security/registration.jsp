...
<body>
    <div class="sidenav">
        <div class="login-main-text">
            <h2>Primum Partus<br> Registration Page</h2>
        ...
        <div class="col-md-6 col-sm-12">
            <div class="login-form">
                <form id="loginForm">
                    ...
                    <input type="button" class="btn btn-black" value="Register" onclick="registration()">
                    <input type="button" class="btn btn-secondary" value="Login" onclick="redirectToLogin()">
                </form>
            </div>
        </div>
    </div>
